...
//Como podemos comprobar, haciendo los cálculos correspondientes mostrados en 
//las diapositivas: (255+1)*4*(1/1.000.000)*16=16'38ms, midiendo después en el
//osciloscopio vemos que el periodo es 16ms.
